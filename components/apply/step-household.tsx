        ...
        <div className="space-y-1">
          ...
          <div className="pt-2">
            ...
            <textarea
              ...
              className="w-full rounded-btn border border-line-2 bg-paper p-3 text-[15px] font-medium tracking-[-0.16px] text-ink placeholder:text-mute-2 transition-opacity duration-200 ease-out hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
            />
