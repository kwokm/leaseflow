    ...
    <div>
      ...
      >
        <input
          ...
          className="mt-0.5 h-5 w-5 shrink-0 cursor-pointer rounded-[6px] border border-line-2 accent-fill transition-opacity duration-200 ease-out hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
        />
        <span>{children}</span>
      </label>
      <FieldError id={errorId ?? `${id}-error`} message={error} />
