 ...
 * listing may well exist, and telling a renter their landlord's link is dead
 * when the truth is a database blip loses an application.
 */
        ...
        <SpatialMount>
          <section className="window px-8 py-12 text-center sm:px-12">
            ...
            <h1 className="mt-2 text-[28px] font-semibold tracking-[-0.7px] text-ink">
              We can&rsquo;t open this application right now.
            </h1>
