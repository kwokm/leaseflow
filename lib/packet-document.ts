...
${submittedBlock}
<footer>
  Generated by LeaseFlow (demo prototype). Screening data is fictional — no consumer reporting
  agency was used.
</footer>
</body>
</html>`;
...
export function downloadPacket(input: PacketInput) {
  ...
  link.href = url;
  link.download = `leaseflow-packet-${input.applicant.firstName}-${input.applicant.lastName}.html`.toLowerCase();
